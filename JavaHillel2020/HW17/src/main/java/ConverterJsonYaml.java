...
public class ConverterJsonYaml {
    ...
    public static void toJson() throws IOException {
        ...
        Object json = new YAMLMapper().readValue(new FileReader(
                "C:\\Users\\sokol\\IdeaProjects\\JavaHillel2020\\JavaHillel2020\\HW17\\src\\main\\resources\\myPerson.yaml"), Object.class);
